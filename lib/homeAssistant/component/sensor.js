...
*/
class HomeAssistantSensorComponent extends HomeAssistantComponent {
    constructor(config, { mqttConnection, debug, allStates, node_id, object_id }) {
        ...
        super(config, { mqttConnection, allStates, debug, domain: 'sensor', node_id, object_id });
...
module.exports = HomeAssistantSensorComponent;
